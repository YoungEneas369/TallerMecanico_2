...
# Definición de la clase base abstracta Vehiculo para representar los vehículos en el sistema
class Vehiculo(ABC):
    ...
    # Método abstracto para retornar la tarifa por hora del vehículo
    @abstractmethod
